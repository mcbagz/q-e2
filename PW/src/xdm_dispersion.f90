...
MODULE xdm_module
  ...
  ! up to Z=102;
  ! for Z=103-120 polarizabilities taken  from:
  !      https://ctcp.massey.ac.nz/2023Tablepol.pdf  
  !   of   https://doi.org/10.1080/00268976.2018.1535143 
  REAL(DP), PARAMETER :: alpha_free(1:120) = (/   &
     0.6668_DP,   &  ! H(Z=1)
     0.2051_DP,   &  ! He(Z=2)
     24.3300_DP,  &  ! Li(Z=3)
     5.6000_DP,   &  ! Be(Z=4)
     ...
     11.2620_DP,  &  ! Ts (Z=117)
      8.5947_DP,  &  ! Og (Z=118)
     25.0432_DP,  &  ! Unu(Un) (Z=119)
     23.5614_DP   &  ! Ubn(Ub) (Z=120)
      /) / bohr_radius_angs**3
