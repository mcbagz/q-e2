  ...
  DO ik = 1, nksq
     ...
     IF ( .NOT. lgamma ) THEN
        ...
        IF ( ABS( xq(1) - ( xk(1,ikq) - xk(1,ikk) ) ) > eps8 .OR. &
           ...
           CALL errore( 'kcw_init_q', 'wrong order of k points', 1 )
        ENDIF
        !
     ENDIF
     !
