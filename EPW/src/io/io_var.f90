  ...
  INTEGER :: iospectral_cum  = 75  ! Electronic spectral function with the cumulant method
                                   ! [specfun_cum##.elself]
  INTEGER :: iuelself_wfpt   = 76  ! Electron self-energy computed using WFPT
                                   ! [elself_wfpt_sup]
...
! SP : Not used for now but could be in the future. Would require the amn as well.
  ...
  INTEGER :: iwfplrn         = 360 ! Polaron wf coefficients
  INTEGER :: idtauplrn       = 361 ! Polaron displacement coefficients
