...
if(FFTW3_DOUBLE AND "DOUBLE" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_FLOAT AND "FLOAT" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_LONGDOUBLE AND "LONGDOUBLE" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_DOUBLE_THREADS AND "DOUBLE_THREADS" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_FLOAT_THREADS AND "FLOAT_THREADS" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_LONGDOUBLE_THREADS AND "LONGDOUBLE_THREADS" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_DOUBLE_OPENMP AND "DOUBLE_OPENMP" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_FLOAT_OPENMP AND "FLOAT_OPENMP" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_LONGDOUBLE_OPENMP AND "LONGDOUBLE_OPENMP" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_DOUBLE_MPI AND "DOUBLE_MPI" IN_LIST FFTW3_FIND_COMPONENTS)
...
if(FFTW3_FLOAT_MPI AND "FLOAD_MPI" IN_LIST FFTW3_FIND_COMPONENTS)
